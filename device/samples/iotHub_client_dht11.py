...
connection_string = "HostName=redischool01.azure-devices.net;DeviceId=phineas;SharedAccessKey=cUCqyEje6VoqadvRpUFz8zTfrQ62ufKk/EgocNMXaqU="
deviceId="phineas"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print('Attempting a read of DHT11 1 on RasberryPi 3')
        ...
        # msg_txt = "{\"DeviceRef\": \"RaspPi3DH11\",\"Temp\": %.2f, \"Humidity\": %.2f}"
        msg_txt = "{\"devicename\": \"%s\",\"Temp\": %.2f, \"Humidity\": %.2f}"
      
        msg_txt_formatted = msg_txt % (deviceId, temperature,humidity)
